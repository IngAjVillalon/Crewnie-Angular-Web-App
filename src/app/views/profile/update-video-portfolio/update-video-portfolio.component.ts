...
@Component({
  selector: 'app-update-video-portfolio',
  templateUrl: './update-video-portfolio.component.html',
  styleUrls: ['./update-video-portfolio.component.scss']
})
export class UpdateVideoPortfolioComponent implements OnInit {
  userId;
  ...
  selectFileToUpload(event) {
    ...
    document.getElementById('currentVideoPreview').innerHTML='<source src="'+fileURL+'" type="video/mp4">';
    videoNode.load()
